...
- Claude Code inside irori cannot see `.agents/skills/` yet. Codex reads it
  natively; the equivalent for the other harnesses is proposed work in the irori
  repository. [ADR 001](docs/decisions/001-kb-structure.md) records why the
  skills are not duplicated per runtime instead.
